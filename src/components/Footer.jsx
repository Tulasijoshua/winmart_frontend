...
const Footer = () => {
  return (
    <div className='w-full py-[4rem] bg-[#000]'>
        <div className='w-[70%] mx-auto flex justify-between items-start gap-[2rem]'>
            <section>
                <div className='w-[5rem] h-[5rem]'>
                    <img className='w-full h-full' src={logo} alt="" />
                </div>
                <div className='pt-[2rem] text-[13px] text-white'>Sunyani, Ghana</div>
            </section>
