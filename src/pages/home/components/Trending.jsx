        ...
        <section className='flex justify-between items-center'>
            {
                trending.map((trend, index) => {
                    return <div className='hover:scale-105 transition-all'>
                        <div className='w-[12rem] h-[15rem] px-1 bg-gray-100 shadow-md border-gray-200  flex flex-col justify-center items-center'>
                        ...
                        <div className='py-[1rem] px-[0.5rem] flex justify-between items-center gap-[1rem]'>
                            <div>
                                <div className='text-[14px]'>{trend.name}</div>
                                <div className='text-[12px]'>Buy now</div>
                            </div>
                            <div>
