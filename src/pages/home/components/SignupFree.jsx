...
const SignupFree = () => {
  return (
    <div className='w-full ml-[2rem] h-[400px] py-[2rem] px-[1.5rem] bg-[#13152D] rounded-bl-[12rem]'>
      <button className='text-white text-[11px] py-[0.4rem] px-[1rem] border border-[#E99517] uppercase rounded-md'>Sign up free</button>
      <div className='pt-[4rem] px-[3.5rem] flex flex-col justify-center items-end gap-[2.5rem]'>
