  ...
  return (
        <div className='w-full xl:pt-[3.5rem] pt-[3rem] xl:pb-[4.5rem] pb-[4rem] bg-[#FF8900]'>
            <div className='w-[500px] mx-auto flex flex-col justify-center items-center'>
                <h2 className='popp text-center xl:text-[1.7rem] text-[1.5rem] text-white font-semibold'>JOIN WINMART COMMUNITY TO GET MONTHLY PROMO</h2>
                <p className='pt-[0.4rem] pb-[2rem] xl:text-[1.1rem] text-[0.9rem] font-medium text-[#FEFEFECC]'>Type your email down below and be wild for big promos</p>
                <div className='p-2 bg-[#ffa400] rounded-xl'>
                  <div className='xl:py-[0.5rem] py-[0.4rem] xl:px-[1.1rem] px-[0.9rem] flex justify-center items-center gap-[3rem] bg-white rounded-xl'>
                    <div>
